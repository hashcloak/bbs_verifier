...
contract BBS_VerifierTest is Test {
    ...
    function test_verify() public {
        ...
        uint256 res6 = verifier.hashToScalar(
            ...
            "BBS_BLS12381G1_XMDSHA256"
        );
        assert(res6 == 7667364271113343805150033528782879942409537702084320607587187534589481273863);

        uint256 res7 = verifier.calculate_domain(pk, 31);
        // console.log(res7);
        assert(res7 == 8098554666098993032244078942950351336992737088924665807721576121865484626965);
    }
}
